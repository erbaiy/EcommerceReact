...
const Header = () => {
  ...
  const [isAuthenticated, setIsAuthenticated] = useState(false); // Instead of redux auth
  const [user, setUser] = useState({
    fullName: 'John Doe',
    email: 'john@example.com',
    role: 'client' // example role
      ...
      <div className="dropdown shrink-0 flex">
        <div className="relative group block">
          <img
            ...
            alt="userProfile"
          />
          <ul className="absolute right-0 mt-2 text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-md shadow-lg hidden group-hover:block">
            <li>
            ...
            {user && (
              <li className="border-t border-white-light dark:border-white-light/10">
                <Link to="/logout" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 text-danger !py-3">
                  <svg

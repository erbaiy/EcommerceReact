...
import { Search, Eye, Check, Loader } from "lucide-react"
...
const OrderManagement = () => {
  ...
  const fetchOrders = async () => {
    ...
    try {
      ...
      toast.success(t("Orders fetched successfully"))
    } catch (error) {
  ...
  useEffect(() => {
    const filtered = orders.filter(order =>
      ...
      order.orderNumber?.includes(searchTerm) // Added orderNumber filtering
    )
